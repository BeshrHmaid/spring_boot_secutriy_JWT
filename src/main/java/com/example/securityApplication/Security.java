...
import com.example.securityApplication.jwt.AuthEntryPointJwt;
import com.example.securityApplication.jwt.AuthTokenFilter;
...
//    }
    ...
    //then make use of command line runner to initialize the data
    //executed on the application startup , after the initilization have been done
    @Bean
